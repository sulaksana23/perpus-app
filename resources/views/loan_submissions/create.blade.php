...
@section('content')
    <section class="mx-auto max-w-2xl rounded-xl border border-slate-200 bg-white p-4 shadow-sm md:p-5">
        ...
        <p class="mb-4 text-sm text-slate-500">Pilih buku yang ingin dipinjam, pengajuan akan dicek admin.</p>

        <form action="{{ route('loan-submissions.store') }}" method="POST" class="space-y-4">
            @csrf
            <div>
